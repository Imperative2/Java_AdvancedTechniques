...
import classes_to_Load.Invert.MyThread;
import classes_to_Load.Invert.MyThread2;

public class UpperCase implements ClassStructure
{
	...
	public void setInput(int port)
	{
		...
		try
		{
			...
			System.out.println("UpperCase running on port : "+port);
		...
		public void run()
		{
			...
			try
			{
				while(true)
				{
					...
					System.out.println("my word UPP: "+word);
					word = upperCase(word);
					System.out.println("after UPP: "+word);
					System.out.println("waiting5 upp");
					out.println(word);
					out.flush();
					break;
				}
