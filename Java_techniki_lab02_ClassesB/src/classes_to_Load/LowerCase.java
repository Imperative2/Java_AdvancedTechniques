...
public class LowerCase implements ClassStructure
{
	...
	public void setInput(int port)
	{
		...
		try
		{
			...
			System.out.println("LowerCase running on port : "+port);
		...
		public void run()
		{
			...
			try
			{
				while(true)
				{
					...
					System.out.println("my word LOW: "+word);
					word = lowerCase(word);
					System.out.println("waiting5 low  " + word);
					out.println(word);
					out.flush();
					break;
				}
